  ...
  return (
    <footer className="bg-black text-gray-400 pt-12 pb-6 border-t border-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        {/* Quick Links (Desktop SAME as before) */}
        <div className="pl-0 md:pl-30">
          <h2 className="text-white font-semibold mb-4 flex text-xl">
            Quick Links
          </h2>
          <ul className="space-y-2 grid grid-cols-2 md:grid-cols-2">
            <li>
            ...
            <li>
              <Link to="/privacypolicy" className="hover:text-red-600 transition">
                Privacy Policy
              </Link>
            </li>
            <li>
        ...
        {/* Follow Us (Desktop SAME spacing) */}
        <div className="pl-0 md:pl-30">
